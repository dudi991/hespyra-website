      ...
      <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          {tableData.map((row, idx) => (
            <div key={idx} className="bg-white rounded-sm border border-primary/10 overflow-hidden shadow-[0_4px_15px_rgba(28,25,23,0.02)] text-left">
              ...
              <div className="divide-y divide-primary/5">
                {/* HESPYRA Column */}
                <div className="bg-[#F7F4ED]/50 px-3.5 py-2.5">
        ...
        <div className="hidden md:block max-w-3xl mx-auto bg-white rounded-sm overflow-hidden shadow-[0_8px_30px_rgba(28,25,23,0.03)] border border-primary/10">
          ...
          <div className="grid grid-cols-12 border-b border-primary/10 items-stretch">
            ...
            <div className="col-span-4 text-center py-5 sm:py-6 text-primary bg-[#F7F4ED] border-x border-primary/10 flex items-center justify-center font-serif text-xs sm:text-sm tracking-[0.15em] font-normal uppercase">
              {columnHeaders[0]}
            </div>
          ...
          <div className="divide-y divide-primary/10">
            {tableData.map((row, idx) => (
              <div key={idx} className="grid grid-cols-12 items-stretch">
                ...
                {/* HESPYRA Column */}
                <div className="col-span-4 text-center px-3 sm:px-4 py-4 sm:py-5 text-primary bg-[#F7F4ED] border-x border-primary/10 flex items-center justify-center font-sans text-[12.5px] sm:text-[13.5px] md:text-[14.5px] font-normal tracking-wide leading-relaxed">
                  {row.hespyra}
                </div>
