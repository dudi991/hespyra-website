      ...
      <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[14px] md:gap-6 lg:gap-8 max-w-5xl mx-auto items-stretch">
          {cases.map((item, idx) => (
            <div 
              key={idx} 
              className="bg-[#F3F1EC] p-[15px] sm:p-10 border border-primary/5 rounded-sm text-left flex flex-col justify-start transition-all duration-300 hover:translate-y-[-2px] shadow-[0_8px_24px_rgba(28,25,23,0.02)] h-full"
            >
              {/* Numbering */}
