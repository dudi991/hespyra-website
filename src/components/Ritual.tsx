  ...
  return (
    <section id="ritual" className="w-full bg-[#F2EDE4] pt-9 lg:pt-20 pb-6 lg:pb-12 overflow-hidden relative z-10">
      <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12 text-center">
        ...
        <p className="font-sans text-[13px] sm:text-base text-primary/75 leading-relaxed font-light max-w-2xl mx-auto mb-8 lg:mb-16 select-none">
          {t('ritual.desc')}
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-col justify-between pt-4.5 pb-4 md:pt-10 md:pb-8 px-6 sm:px-8 lg:px-12 text-left min-h-0 md:min-h-[320px] border-b md:border-b-0 md:border-r border-primary/10">
            <div>
              ...
              <h3 className="font-serif text-2xl lg:text-3xl text-primary font-normal mb-1.5 md:mb-4">
                {t('ritual.step1_tag')}
              </h3>
              <p className="font-sans text-[12.5px] sm:text-sm lg:text-[15px] leading-relaxed text-primary/60 font-light whitespace-pre-line">
                {t('ritual.step1_text')}
              </p>
            </div>
            <div className="text-primary/60 mt-3 md:mt-8 flex-shrink-0">
              <GlassWater className="w-[16px] h-[16px] md:w-5 md:h-5" strokeWidth={1.2} />
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between pt-4.5 pb-4 md:pt-10 md:pb-8 px-6 sm:px-8 lg:px-12 text-left min-h-0 md:min-h-[320px] border-b md:border-b-0 md:border-r border-primary/10">
            ...
            <div className="text-primary/60 mt-3 md:mt-8 flex-shrink-0">
              <ChevronsUp className="w-[16px] h-[16px] md:w-5 md:h-5" strokeWidth={1.2} />
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between pt-4.5 pb-4 md:pt-10 md:pb-8 px-6 sm:px-8 lg:px-12 text-left min-h-0 md:min-h-[320px]">
            ...
            <div className="text-primary/60 mt-3 md:mt-8 flex-shrink-0">
              <Moon className="w-[16px] h-[16px] md:w-5 md:h-5" strokeWidth={1.2} />
            </div>
          </div>
